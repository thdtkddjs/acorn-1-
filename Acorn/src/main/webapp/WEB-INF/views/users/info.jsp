...
<body class="text-center">
	<div class="container">
	   ...
	   <a href="javascript:deleteConfirm()" class="btn btn-outline-danger">DROP-OUT</a>
		...
		<form id="imageForm" action="${pageContext.request.contextPath}/users/update"
			method="post">
	...
	<script>
	   ...
	   document.querySelector("#edit_link").addEventListener("click", function(){
      ...
      $("#edit_email_box").on("propertychange change keyup paste input", function() {
